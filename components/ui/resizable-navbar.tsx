...
export const Navbar = ({ children, className }: NavbarProps) => {
  ...
  return (
    <motion.div
      ...
      className={cn("fixed inset-x-0 top-6 lg:top-16 z-40 w-full", className)}
    >
...
export const NavbarLogo = () => {
  return (
    ...
    >
      <Image
        src="https://asclepios-medical.ro/wp-content/uploads/2025/09/logo.png"
        alt="logo"
        width={30}
        height={30}
      />
      <span className="font-medium text-black">Asclepios</span>
    </Link>
  );
};
